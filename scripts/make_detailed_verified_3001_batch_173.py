"""Verified register for five canonical rows beginning at 0592.003."""
import csv

START = ("0592", "003")
OUTPUT = "data/research_batches/detailed_verified_3001_batch_173.csv"
FIELDS = (
...
TEI_URLS = {
    "003": "https://scaife.perseus.org/reader/urn:cts:greekLit:tlg0592.tlg003.1st1K-grc1:1.1",
    "004": "https://scaife.perseus.org/reader/urn:cts:greekLit:tlg0592.tlg004.1st1K-grc1:1.1.1",
    "005": "https://scaife.perseus.org/reader/urn:cts:greekLit:tlg0592.tlg005.1st1K-grc1:1",
}
...
with open(OUTPUT, "w", newline="", encoding="utf-8") as handle:
    ...
    for work in works:
        ...
        if key[1] in TEI_URLS:
            ...
            row.update(
                sources_tested="Exact TLG/First1K lookup; cited Rabe or FGrH bibliographic record checked.",
