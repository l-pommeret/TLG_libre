"""Verified register for 3364.001, 1758.001, 2259.001, 0195.001/x01; no local assets."""
import csv
TARGETS=[('3364','001'),('1758','001'),('2259','001'),('0195','001'),('0195','x01')];OUTPUT='data/research_batches/detailed_verified_3001_batch_127.csv'
