...
START = ('3210', '002')
OUTPUT = 'data/research_batches/detailed_verified_3001_batch_211.csv'
...
with open(OUTPUT, 'w', newline='', encoding='utf-8') as handle:
    ...
    for source in coverage[start:start + 5]:
        ...
        row.update(
            tlg_author_id=source['tlg_author_id'],
        ...
        if source['record_type'] == 'cross_reference':
            row.update(
                sources_tested='Canonical notice and its named TLG cross-reference checked.',
            ...
            row.update(
                sources_tested='Exact TLG/First1K lookup; cited critical-edition bibliographic record checked.',
