"""Verified register for five canonical rows beginning at 1419.002."""
import csv

START = ("1419", "002")
OUTPUT = "data/research_batches/detailed_verified_3001_batch_164.csv"
FIELDS = (
...
with open(OUTPUT, "w", newline="", encoding="utf-8") as handle:
    ...
    for work in works:
        ...
        row.update(
            ...
            sources_tested="Exact TLG/First1K lookup; cited Whittaker/Joly or FGrH bibliographic record checked.",
