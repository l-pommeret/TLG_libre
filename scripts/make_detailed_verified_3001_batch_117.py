"""Verified register for 2017.063--067; records PG page images, never downloads them."""
import csv
IDS=("063","064","065","066","067")
OUTPUT="data/research_batches/detailed_verified_3001_batch_117.csv"
