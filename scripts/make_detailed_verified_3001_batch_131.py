"""Verified register for five rows after 1388.002, resolving cross-references."""
import csv

START = ("0720", "001")
OUTPUT = "data/research_batches/detailed_verified_3001_batch_131.csv"
...
assert len(rows) == 5
xrefs = {("0912", "x01"): "0057.077, 0057.078 (Galenus, Med.)", ("0914", "x01"): "0057.076, 0057.077 (Galenus, Med.)"}
