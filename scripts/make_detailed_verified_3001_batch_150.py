"""Verified register for rows from 1403.001, resolving three cross-references."""
import csv
START=("1403","001");OUTPUT="data/research_batches/detailed_verified_3001_batch_150.csv"
...
xrefs={("2808","x01"):"7051.001 (Doctrina patrum)",("2808","x02"):"2892.021 (Maximus Confessor)",("2769","x01"):"5238.001 (Vita Olympiadis)"}
