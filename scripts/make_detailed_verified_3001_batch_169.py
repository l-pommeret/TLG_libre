"""Verified register for five canonical rows beginning at 0252.001."""
import csv

START = ("0252", "001")
OUTPUT = "data/research_batches/detailed_verified_3001_batch_169.csv"
FIELDS = (
...
with open(OUTPUT, "w", newline="", encoding="utf-8") as handle:
    ...
    for work in works:
        ...
        row.update(
            ...
            sources_tested="Exact TLG/First1K lookup; cited Kock, Meineke, Demianczuk, West, or Austin bibliographic record checked.",
