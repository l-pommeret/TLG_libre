"""Verified register for rows after 1402.003, resolving two cross-references."""
import csv
START=("1402","004");OUTPUT="data/research_batches/detailed_verified_3001_batch_149.csv"
...
xrefs={("1402","x01"):"3002.018 (Prolegomena de comoedia)",("0883","x01"):"0722.001 (Oribasius, Med.)"}
