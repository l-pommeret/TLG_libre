"""Verified register for five canonical rows from 1390.002; no image/OCR download."""
import csv
START=("1390","002");OUTPUT="data/research_batches/detailed_verified_3001_batch_134.csv"
