"""Verified register for five canonical rows beginning at 3297.003."""
import csv

START=("3297","003")
OUTPUT="data/research_batches/detailed_verified_3001_batch_196.csv"
FIELDS="tlg_author_id tlg_work_id author_heading work_title canonical_edition sources_tested open_text_result open_text_url open_text_license scan_result scan_url scan_rights confidence proposed_status next_action notes last_checked".split()
HOSTS={"x01":"0057.011, 0057.016, 0057.021, 0057.059, 0057.060, and 0057.076 (Galenus, Med.)","x02":"0722.001 (Oribasius, Med.)","x03":"0643.001 (Anonymus Londinensis, Med.)"}
