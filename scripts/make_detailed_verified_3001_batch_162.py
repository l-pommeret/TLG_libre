"""Verified register for five canonical rows beginning at 2426.001."""
import csv

START = ("2426", "001")
OUTPUT = "data/research_batches/detailed_verified_3001_batch_162.csv"
FIELDS = (
...
with open(OUTPUT, "w", newline="", encoding="utf-8") as handle:
    ...
    for work in works:
        ...
        row.update(
            ...
            sources_tested="Exact TLG/First1K lookup; cited FGrH/FHG or Matthes bibliographic record checked.",
