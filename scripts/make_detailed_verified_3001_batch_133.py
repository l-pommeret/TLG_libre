"""Verified register for five canonical rows from 0538.001; resolves duplicate fragments."""
import csv
START=("0538","001");OUTPUT="data/research_batches/detailed_verified_3001_batch_133.csv"
...
with open(OUTPUT,"w",newline="",encoding="utf-8") as fh:
 ...
 for w in rows:
  ...
  if key==("0538","004"):
   r.update(sources_tested="Canon duplicate relation checked: 0538.004 duplicates 0538.002 in FHG 1.",open_text_result="No independent acquisition: 0538.002 controls shared fragments.",scan_result="No separate scan candidate: duplicate edition record.",confidence="high",proposed_status="DUPLICATE_EDITION_REFERENCE",next_action="Use 0538.002 as text host; retain FHG citation as bibliographic reference.",notes="No duplicate text/image acquisition.")
  else:
