"""Verified register for five canonical rows beginning at 0087.022."""
import csv

START = ("0087", "022")
OUTPUT = "data/research_batches/detailed_verified_3001_batch_182.csv"
...
with open(OUTPUT, "w", newline="", encoding="utf-8") as handle:
    ...
    for work in works:
        key = (work["tlg_author_id"], work["tlg_work_id"]); tei = verification[key]; row = {field: "" for field in FIELDS}
