"""Verified register for five canonical rows from 1393.004; no image/OCR download."""
import csv
START=("1393","004");OUTPUT="data/research_batches/detailed_verified_3001_batch_138.csv"
...
with open(OUTPUT,"w",newline="",encoding="utf-8") as fh:
 ...
 for w in rows:
  ...
  if key==("1393","005"):
   r.update(sources_tested="Canon partial-duplication relation checked: 1393.005 overlaps 1393.003 in FHG 3.",open_text_result="Partial overlap: no acquisition decision until fragment-by-fragment comparison.",scan_result="No separate scan candidate confirmed.",confidence="medium",proposed_status="PARTIAL_DUPLICATION_REVIEW",next_action="Compare FHG fragments with 1393.003; retain only non-overlapping material; no OCR.",notes="Partial duplication must not be treated as a full cross-reference.")
  else:
