"""Verified register for 2017.058--062; records PG page images, never downloads them."""
import csv
IDS=("058","059","060","061","062")
OUTPUT="data/research_batches/detailed_verified_3001_batch_116.csv"
