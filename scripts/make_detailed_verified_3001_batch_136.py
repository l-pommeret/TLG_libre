"""Verified register for five canonical rows from 0463.004; no image/OCR download."""
import csv
START=("0463","004");OUTPUT="data/research_batches/detailed_verified_3001_batch_136.csv"
...
with open(OUTPUT,"w",newline="",encoding="utf-8") as fh:
 ...
 for w in rows:
  r={f:"" for f in FIELDS};r.update(tlg_author_id=w["tlg_author_id"],tlg_work_id=w["tlg_work_id"],author_heading=w["author_heading"],work_title=w["work_title"],canonical_edition=w["bibliographic_notice"],sources_tested="Exact TLG/First1K lookup; cited FGrH/Anthologia catalogue check",open_text_result="No exact licensed TEI match in local corpus.",scan_result="No edition-matching reusable page-image source verified.",confidence="medium",proposed_status="EDITION_IDENTIFIED",next_action="Locate a rights-cleared scan of the cited edition; do not substitute OCR.",notes="No image acquired.",last_checked="2026-08-11");out.writerow(r)
