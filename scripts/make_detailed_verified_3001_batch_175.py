"""Verified register for five canonical rows beginning at 3307.003."""
import csv

START = ("3307", "003")
OUTPUT = "data/research_batches/detailed_verified_3001_batch_175.csv"
FIELDS = (
...
with open(OUTPUT, "w", newline="", encoding="utf-8") as handle:
    ...
    for work in works:
        ...
        row.update(
            ...
            sources_tested="Exact TLG/First1K lookup; cited Lampros, MPG, or Kalatzi bibliographic record checked.",
