"""Verified register for five canonical rows beginning at 0087.007."""
import csv

START = ("0087", "007")
OUTPUT = "data/research_batches/detailed_verified_3001_batch_179.csv"
FIELDS = (
...
assert len(works) == 5
assert all((w["tlg_author_id"], w["tlg_work_id"]) in verification for w in works)
