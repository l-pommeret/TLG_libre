"""Verified register for the five canonical rows beginning at 0916.x01."""
import csv

START = ("0916", "x01")
OUTPUT = "data/research_batches/detailed_verified_3001_batch_154.csv"
FIELDS = (
...
HOSTS = {
    ("0916", "x01"): "0715.001 (Paulus, Med.)",
    ("1033", "x01"): "0744.003 (Alexander Trallianus, Med.)",
}
...
with open(OUTPUT, "w", newline="", encoding="utf-8") as handle:
    ...
    for work in works:
        ...
        if key in HOSTS:
            ...
            row.update(
                sources_tested="Exact TLG/First1K lookup; cited SVF, TrGF, or Geographi Graeci Minores bibliographic record checked.",
